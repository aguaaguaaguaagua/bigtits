...
void FlanAndSurfMatcherExtract(const Mat&,const Mat&, const string &);
void SurfFeatureDetect(const Mat&,vector<KeyPoint>&);
/////////////////////////////////////////////////
//ÕÒµ½ÌØÕ÷µã,SURF
...
void FlanAndSurfMatcherExtract(const Mat& src1,const Mat& src2,const string &exType)
{
